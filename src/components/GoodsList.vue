    ...
    <div class="container">
      ...
      <div class="goods-box">
        ...
        <div class="goods-list-box">
          ...
          <div class="goods-list">
            <div class="goods-show-info" v-for="(item, index) in orderGoodsList2" :key="index">
              ...
              <div class="goods-show-num">
                用户评价:<br><span>{{item.productdecs}}</span>
              </div>
      ...
      <div class="goods-page">
        <Page :total="count"
              ...
              :page-size="par.size"
              :page-size-opts="arr"
              @on-change="changePagestar"
              @on-page-size-change="changePagetiao"
              show-sizer
        >
        </Page>
      </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      loadGoodsList1(){
        this.$ajax.post("http://localhost:20001/feigon/shop/queryShang",this.$qs.stringify(this.par)).then(rs=>{
          if(rs.data.data.code==200){
            this.orderGoodsList2=rs.data.data.data.list;
            this.count=rs.data.data.data.count;
          }
    ...
    created () {
     this.par.typeid=this.$route.query.tid;
      //this.loadGoodsList();
      this.loadGoodsList1();
